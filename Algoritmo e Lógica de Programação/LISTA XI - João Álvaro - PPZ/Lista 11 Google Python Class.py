...
# PRIMEIRA TENTATIVA:   return frase.count(palavra)
def busca(frase, palavra):
  contador = 0
  # Loop para percorrer os indices de uma string, len vé o tamanho da string e range cria os indices.
  for k in range(len(frase)):
    # se o indice da frase até o indice mais o tamanho da palavra
    # a encontrar forem igual a palavra a encontrar
    # contabilizar +1 no contador
